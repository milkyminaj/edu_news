...
<body>
    ...
    while ($data = mysqli_fetch_array($datas)) {
        $id = $data['id_kategori'];
        $kategori_berita = $data['kategori_berita'];
    }
    ?>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li class="mega-menu mega-menu-sm">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="./index_topik.php">Topik</a></li>                            
                        </ul>
                    </li>
                                            ...
                                            <!--<div class="card">-->
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="id" name="id_Kategori" placeholder="ID Kategori" required value="<?php echo $id ?>" disabled>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="kategori_berita" class="form-label">Nama Kategori</label>
                                                        <input type="text" class="form-control" id="kategori_berita" name="kategori_berita" placeholder="Nama Kategori" required value="<?php echo $kategori_berita ?>" disabled>
                                                    </div>
                                                    <a href="index_kategori.php" class="btn btn-primary button-blue" style="color=white;">Kembali</a>
                                                </div>
                                            <!--</div>-->
                                        </div>
                                    <!--</div>-->
