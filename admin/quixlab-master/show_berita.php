                                            ...
                                            <!--<div class="card">-->
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control" id="gambar" name="gambar" placeholder="Gambar Thumbnail" required value="<?php echo $gambar ?>" disabled>
                                                        <div class="mt-3">
                                                            <img src="gambar/<?php echo $gambar ?>" style="width: 300px;">
                                                        </div>
                                                    </div>
                                                    <div class="mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="date" class="form-label">Tanggal Unggah</label>
                                                        <input type="text" class="form-control" id="date" name="date" placeholder="Tanggal Unggah" required value="<?php echo $date ?>" disabled>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="penulis" class="form-label">Author</label>
                                                        <input type="text" class="form-control" id="penulis" name="penulis" placeholder="Author" required value="<?php echo $penulis ?>" disabled>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="konten" class="form-label">Isi Konten Berita</label>
                                                        <textarea type="text" class="form-control" id="konten" name="konten" required disabled><?php echo $konten ?></textarea>
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="id_kategori" class="form-label">ID Kategori</label>
                                                        <input type="text" class="form-control" id="id_kategori" name="id_kategori" placeholder="Author" required value="<?php echo $id_kategori ?>" disabled>
                                                    </div>
                                                    <a href="index_berita.php" class="btn btn-primary button-blue" style="color=white;">Kembali</a>
                                                </div>
                                            <!--</div>-->
                                        </div>
                                    <!--</div>-->
